...
export var WebSocketPrint = function(serverURL, strPrinterName, request, callback){
	var _websocket;
...
export function requestMSRData(strPrinterName, timeout, _callback) {
...
export function checkResult(method, strPrinterName, requestId, responseId, _callback) {
	var serverURL = getServerURL().url;
