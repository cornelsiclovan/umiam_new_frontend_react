...
export function printBuffer() { switch(arguments.length) {
    case 0:
        var _a = {printBuffer:[]};
        label_func["func"+incLabelNum] = _a;
        incLabelNum++;
...
export function drawVectorFont(text, x, y, fontType, fontWidth, fontHeight, rightSpacing, bold, invert, italic, rotation, alignment, rtol) {
...
export function drawPDF417(data, x, y, maxRowCount, maxColumnCount, eccLevel, dataCompressionMethod, hri, barcodeOriginPoint, moduleWidth, barHeight, rotation) {
...
export function drawAztec(data, x, y, size, extendedChannel, eccSymbol, menuSymbol, numberOfSymbols, optionalID, rotation) {
...
export function drawRSSBarcode(data, x, y, rssType, magnification, separatorHeight, barcodeHeight, segmentWidth, rotation) {
...
export function setRFIDPosition(transPosition) {
    var _a = {sertRFIDPosition:[transPosition]};
    label_func["func"+incLabelNum] = _a;
    incLabelNum++;
}
